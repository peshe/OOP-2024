...
**Цел:** Използвайте темплейти за изчисляване на факториала на число по време на компилация. Создайте темплейт структура `Factorial<N>`, която връща стойността на факториала на `N`.
